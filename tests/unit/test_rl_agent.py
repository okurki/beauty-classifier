...
def test_celebrity_state_initialization():
    ...
    state = CelebrityState(
        celebrity_id=1, celebrity_name="test_celebrity", alpha=1.0, beta=1.0
    )
...
def test_celebrity_state_mean_probability():
    ...
    state = CelebrityState(celebrity_id=1, celebrity_name="test", alpha=3.0, beta=1.0)
...
def test_celebrity_state_uncertainty():
    ...
    state = CelebrityState(celebrity_id=1, celebrity_name="test", alpha=10.0, beta=10.0)
...
def test_celebrity_state_sampling():
    ...
    state = CelebrityState(celebrity_id=1, celebrity_name="test", alpha=5.0, beta=2.0)
...
def test_rl_metrics_average_reward():
    ...
    metrics = RLMetrics(cumulative_reward=10.0, total_impressions=5)
...
def test_rl_metrics_ctr():
    ...
    metrics = RLMetrics(total_impressions=100, total_likes=30, total_dislikes=20)
...
def test_rl_metrics_like_rate():
    ...
    metrics = RLMetrics(total_likes=30, total_dislikes=10)
...
def test_agent_initialization():
    ...
    agent = ThompsonSamplingAgent(alpha_prior=1.0, beta_prior=1.0, context_weight=0.3)
...
def test_agent_select_celebrities_basic():
    ...
    selected = agent.select_celebrities(
        candidate_celebrities=candidates, context=None, top_k=2
    )
...
def test_agent_select_celebrities_with_context():
    ...
    selected = agent.select_celebrities(
        candidate_celebrities=candidates, context=context, top_k=2
    )
...
def test_agent_exploration_bonus():
    ...
    agent = ThompsonSamplingAgent(exploration_bonus=0.1, min_impressions=5)
