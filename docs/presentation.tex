...
\usepackage{booktabs}
\usepackage{amsmath}
\title{Facial Analysis \& Recommendation System via Reinforcement Learning}
\subtitle{Contextual Thompson Sampling for Personalized Celebrity Look-alike}
\author{[Team Member Name 1] \and [Team Member Name 2] \and [Team Member Name 3]}
\institute{PMLDL / CV / RL Course Project}
\date{\today}
\usetheme{Madrid}
\begin{document}
\frame{\titlepage}
...
\begin{frame}{Team Contributions}
    \begin{itemize}
        \item \textbf{[Team Member 1]:} 
        \begin{itemize}
            \item Backend architecture design (FastAPI).
            \item Implementation of RL logic (Thompson Sampling).
            \item Database schema design.
        \end{itemize}
        
        \item \textbf{[Team Member 2]:}
        \begin{itemize}
            \item Computer Vision model training (ResNet50, InceptionResnet).
            \item Data preprocessing and augmentation pipelines.
            \item Model evaluation and metrics tracking.
        \end{itemize}
...
\begin{frame}{Summary & Future Work}
    ...
    \begin{itemize}
        ...
        \item \textbf{Full Integration:} Connect Flutter frontend to live Backend RL endpoints (currently mocked for demo).
    \end{itemize}
\end{frame}
\end{document}